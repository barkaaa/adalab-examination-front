                ...
                <div style="display: flex; flex-direction: column">
                  ...
                  >
                    ...
                    <a-modal
                        ...
                        @close="saveChange(index, question)"
...
export default defineComponent({
  ...
  setup() {
    ...
    const moreDetails = (index, question) => {
      ...
      changeDescription.value= deepCopy(question.description);
      if (question.options) {
    ...
    const saveChange = (index, question) => {
      question.questionType = deepCopy(changeTypeMark.value);
      question.description = deepCopy(changeDescription.value);
      if (changeTypeMark.value == "选择") {
        question.options = [];
        question.options = deepCopy(changeChoices.value);
      }
    };
